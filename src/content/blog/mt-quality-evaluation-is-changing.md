...
A 2026 ACL (Association for Computational Linguistics) industry paper proposed a two-stage approach called "Diagnose, Then Repair." Instead of asking an LLM to simply "judge and improve" a translation, the system first identifies specific error spans and assigns MQM-style diagnoses and severity. A separate model then performs constrained repairs based on those diagnoses. The researchers report better controllability and less unwanted paraphrasing than a one-stage judge-and-refine approach. ([Wang & Wu, ACL 2026](https://aclanthology.org/2026.acl-industry.115/)) This suggests an important design principle: evaluation and correction should not necessarily be the same task.
